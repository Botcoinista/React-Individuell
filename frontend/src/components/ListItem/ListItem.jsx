    ...
    setTimeout(() => {
      fetch(`http://localhost:8080/api/products/${productId}`, {
        ...
        .then((data) => {
          ...
          setProducts(
            (prevProducts) =>
              prevProducts.filter((product) => product._id !== productId) // Filters out the deleted product from the products state
          );
        })
        ...
        <div className="product-right">
          <div className="details">
            ...
            <div className="productlist-description">
              {/* <textarea className="description-textarea" name="description" id="description" cols="30" rows="10"> */}
